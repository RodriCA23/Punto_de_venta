...
<body class="container">
    <div class="container text-center mt-5">
        ...
        <div class="row mt-5">
            <div class="col">
                <a href="nuevacompra.php"><img alt="" src="../assets/nuevacompra.png" width="100"/></a>
                <p>Nueva Compra</p>
            </div>
            <div class="col">
                <a href="buscarcompra.php"><img alt="" src="../assets/buscar.png" width="100"/></a>
                <p>Buscar Compra</p>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col">
                <a href="Listacompras.php"><img alt="" src="../assets/listado.png" width="100"/></a>
