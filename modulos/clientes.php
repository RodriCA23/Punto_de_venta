...
<body class="container-fluid">
    <div class="container-fluid text-center mt-5">
        ...
        <div class="row mt-5">
            <div class="col-6">
                <a href="./acciones/addcliente.php"><img alt="" src="../assets/adduser.png" width="70"/></a>
                <p>Agregar Cliente</p>
            </div>
            <div class="col-6">
        ...
        if (isset($_POST['filtro'])) {
            ...
            if($opcionSeleccionada==1){
                $sql="SELECT * FROM clientes where id=$buscar";
            }
...
if (mysqli_num_rows($resultado) > 0) {
    ...
    while ($fila = mysqli_fetch_array($resultado)) {
        ...
        echo "<td><a href='./acciones/editar2.php?id={$fila['id']}' class='btn btn-success'>Editar</a></td>";
        echo "<td><a href='./acciones/eliminar2.php?id={$fila['id']}' class='btn btn-danger'>Borrar</a></td>";
