...
<body class="container-fluid">
    <div class="container-fluid text-center mt-5">
            ...
            <div class="container-fluid mt-4">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <h4>Categoria</h4>
                        <input type="text" class="form-control" value="" name="cate" />
                        <h4>Medida</h4>
                        <input type="text" class="form-control" value="" name="Medida" />
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <a href="../ListaProductos.php" class="btn btn-danger"><i class="bi bi-x"></i>Cerrar</a>
                        </div>
                        <div class="col-md-1"></div>
        ...
        $Medida=$_POST['Medida'];
        $sql = "INSERT INTO productos (nombre, categoria, medida) VALUES ('$nombre','$categoria', '$Medida')";
