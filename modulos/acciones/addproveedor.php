...
<body class="container-fluid">
    <div class="container-fluid text-center mt-5">
        <div class="row">
            ...
            <a href="../../index.php"><img alt="cerrar sesion" src="../../assets/verificar.png" width="50"/></a>
            </div>
        </div>
        ...
        <form method="post">
            ...
            <div class="container-fluid mt-4">
                ...
                <div class="row mt-4">
                    ...
                    <a href="../proveedores.php" class="btn btn-danger"><i class="bi bi-x"></i>Cerrar</a>
                    </div>
                    <div class="col-md-1"></div>
                </div>
        ...
        $nombre = $_POST['name'];
        $sql = "INSERT INTO provedores (nombre) VALUES ('$nombre')";
