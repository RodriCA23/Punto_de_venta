...
<body class="container">
    <div class="container text-center mt-5">
        ...
        <div class="row mt-5">
            <div class="col">
                <a href="nuevaventa.php"><img alt="" src="../assets/venta.png" width="100"/></a>
                <p>Nueva Venta</p>
            </div>
            <div class="col">
                <a href="buscarventa.php"><img alt="" src="../assets/buscar.png" width="100"/></a>
                <p>Buscar Venta</p>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col">
                <a href="Listaventas.php"><img alt="" src="../assets/listado.png" width="100"/></a>
                <p>Lista de Ventas</p>
            </div>
            <div class="col">
