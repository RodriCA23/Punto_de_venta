...
<body class="container">
    <div class="container text-center mt-5">
        ...
        <div class="row mt-5">
            <div class="col">
                <a href="usuarios.php"><img alt="" src="../assets/usuarios.png" width="100"/></a>
                <p>Usuarios</p>
            </div>
            <div class="col">
                <a><img alt="" src="../assets/permisos.png" width="100"/></a>
                <p>Permisos</p>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col">
                <a><img alt="" src="../assets/datosnegocio.png" width="100"/></a>
