...
if($_POST){
    ...
    $sqlp="SELECT * FROM clientes where nombre= '$pro'";
...
<div class="row">
        ...
        <div class="row mt-5">
            ...
            <div class="col-6">
                <a href="ventas.php"><img alt="" src="../assets/cerrar.png" width="70"/></a>
                <p>Cerrar</p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row mt-5">
            <div class="col-md">
                <p>Doc. Cliente <input type="text" value=<?php echo $idpro?>></p>
            </div>
            <div class="col-md">
            <p>Nombre Cliente <input type="text" value=<?php echo $pro?>></p>
            </form>
            </div>
        </div>
       ...
       <?php
       if($_POST){
        $sqlV="SELECT * FROM detallesV where id=$id";
        $resul=mysqli_query($conn,$sqlV);
       ...
       <div class="row">
        <div class="col-md">
            <p style="text-align:left;">Total :<input type="text" value=<?php echo $total?>> Pago con <input type="text" value=<?php echo $pago?>> Cambio <input type="text" value=<?php echo $cambio?>></p>
        </div>
       </div>
       </div>
